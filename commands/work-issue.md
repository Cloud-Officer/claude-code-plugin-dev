...
12. **Post a tester QA checklist on the issue** (all types)
    ...
    Write the comment in the **same language as the issue** (many issues here are in French — match it). Keep each item short and verifiable by a human who has not seen the diff.
