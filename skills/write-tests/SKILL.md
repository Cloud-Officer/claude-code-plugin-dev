...
- **The test name is the documentation — do not write a comment above a test.** Follow the `code-standards` skill, which owns comment discipline for test files exactly as for production code: default none, hard cap one line, and rationale goes in the PR body.
