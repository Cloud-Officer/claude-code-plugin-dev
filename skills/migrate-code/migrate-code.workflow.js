...
if (mode === 'plan') {
  ...
  const foundation = await agent([
    ...
    '   the migration can proceed bottom-up. Include a rough complexity estimate per file.',
    '',
    ...
    '   build-system and FFI concerns. For each, suggest a handling approach and rate the risk.',
    '',
