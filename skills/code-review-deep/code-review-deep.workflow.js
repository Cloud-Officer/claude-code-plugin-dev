...
const A_QUALITY = {
  ...
  prompt: [
    ...
    'overlong narrative comments no human will maintain - concretely: any comment block of 3+ lines, and any comment',
    'that justifies a CHANGE rather than explaining the CODE (why this approach was picked, what was rejected, how a',
    'sibling module does it, what convention is being matched). Test files count: a motivation block above a test case',
    'is the same defect, since the test name should carry that. Flag the block, quote its first line, propose the',
    'one-line replacement or deletion, and note that the rationale belongs in the PR body.',
