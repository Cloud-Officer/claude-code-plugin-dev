...
| `migrate-code`           | Port a codebase to another language/framework via a six-step engine (rulebook → stress-test → translate/compile/test/verify) | None — uses the repo's own build/test commands + bundled `context7` MCP                                                                                                                                                                        |
