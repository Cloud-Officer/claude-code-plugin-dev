...
| `review-ownership-map`   | Code ownership & bus factor from git history — flags single points of failure on sensitive code                         | None — read-only git analysis                                                                                                                                                                                                                                                                                                             |
...
| `review-threat-model`    | Repo-specific STRIDE threat model — trust boundaries, abuse paths, ISO 27001 evidence                                   | None — read-only code analysis                                                                                                                                                                                                                                                                                                            |
